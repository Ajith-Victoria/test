                                ...
                                <View style={styles.productBox}>
                                    ...
                                    <ScrollView contentContainerStyle={{ flexGrow: 1, position: 'relative' }}>
                                        <View style={{ paddingHorizontal: 10 }}>
                                            ...
                                            {/* {this.state.error && <View>
                                                {(this.state.departmentSelected == '' || this.state.departmentSelected == 'Department') ? <Text style={{ color: 'red', fontSize: 10, marginTop: 3 }}>Select the Department</Text> : <Text style={{ display: 'none' }}></Text>}
                                            </View>} */}
                                            ...
                                            <Text style={{ color: '#14a852', fontWeight: '900', letterSpacing: 0.3, marginTop: 20, fontSize: 16 }}>Loan Period</Text>
